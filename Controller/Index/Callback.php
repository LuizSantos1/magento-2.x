<?php
namespace Tagweb\Paymee\Controller\Index;
...
class Callback extends \Magento\Framework\App\Action\Action
{
        ...
        )
	{
        ...
        $this->helper = $objectManager->create('Tagweb\Paymee\Helper\Data');
    ...
    public function execute() {
        ...
        //$contents = '{"saleToken":"ff66b277-7d76-3a4c-970c-4a50a43fb1ad","referenceCode":"35","currency":"BRL","amount":305.00,"shopper":{"fullName":"nome sobrenome","firstName":"nome","lastName":"sobrenome","email":"andre@tagweb.com.br","cpf":"35313621866","agency":"0000","account":"000000-1"},"date":null,"newStatus":"PAID"} ';
